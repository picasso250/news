...
# HTML_TAG_START AprielGuard: A Guardrail for Safety and Adversarial Robustness in Modern LLM Systems HTML_TAG_END
[Enterprise Article](/blog) Published December 23, 2025 [Upvote 48](/login?next=%2Fblog%2FServiceNow-AI%2Faprielguard) +42 [Jaykumar Kasundra JayKasundraSNOW Follow](/JayKasundraSNOW) [ServiceNow-AI](/ServiceNow-AI) HTML_TAG_START
[HTML_TAG_START Motivation HTML_TAG_END](#motivation) [HTML_TAG_START AprielGuard Overview HTML_TAG_END](#aprielguard-overview) [HTML_TAG_START Taxonomy HTML_TAG_END](#taxonomy) [HTML_TAG_START A. Safety Taxonomy HTML_TAG_END](#a-safety-taxonomy) [HTML_TAG_START B. Adversarial Attack Taxonomy HTML_TAG_END](#b-adversarial-attack-taxonomy) [HTML_TAG_START Training Dataset HTML_TAG_END](#training-dataset) [HTML_TAG_START Model Architecture HTML_TAG_END](#model-architecture) [HTML_TAG_START Training Setup HTML_TAG_END](#training-setup) [HTML_TAG_START Evaluation Summary HTML_TAG_END](#evaluation-summary) [HTML_TAG_START Safety Benchmark Results HTML_TAG_END](#safety-benchmark-results) [HTML_TAG_START Adversarial Detection Results HTML_TAG_END](#adversarial-detection-results) [HTML_TAG_START Agentic Workflow Evaluation HTML_TAG_END](#agentic-workflow-evaluation) [HTML_TAG_START Long-Context Robustness (Upto 32k Tokens) HTML_TAG_END](#long-context-robustness-upto-32k-tokens) [HTML_TAG_START Multilingual evaluation HTML_TAG_END](#multilingual-evaluation) [HTML_TAG_START Conclusion HTML_TAG_END](#conclusion) [HTML_TAG_START Limitations HTML_TAG_END](#limitations) Large Language Models (LLMs) have rapidly evolved from text-only assistants into complex agentic systems capable of performing multi-step reasoning, calling external tools, retrieving memory, and executing code. With this evolution comes an increasingly sophisticated threat landscape: not only traditional content safety risks, but also multi-turn jailbreaks, prompt injections, memory hijacking, and tool manipulation.
...
Model: [https://huggingface.co/ServiceNow-AI/AprielGuard](https://huggingface.co/ServiceNow-AI/AprielGuard) Technical Paper: [https://arxiv.org/abs/2512.20293](https://arxiv.org/abs/2512.20293)
# Table of Contents
[Motivation](#motivation) [AprielGuard Overview](#overview) [Taxonomy](#taxonomy) [Training Dataset](#training_dataset) [Model Architecture](#architecture) [Training Setup](#training) [Evaluation](#evaluation) [Conclusion](#conclusion) [Limitations](#limitations)
## Motivation
...
It outputs:
Safety classification and a list of violated categories from the taxonomy Adversarial attack classification Optional structured reasoning explaining the decision
AprielGuard overview
## Taxonomy
### A. Safety Taxonomy
...
(These 16 categories are inspired from [SALAD-Bench](https://arxiv.org/abs/2402.05044) )
...
Public safety benchmarks Public adversarial benchmarks Internal Agentic workflow benchmarks internal Long-context use case benchmarks (up to 32k) Multilingual evaluation (8 languages)
...
## Conclusion
AprielGuard unifies safety, security, and agentic robustness into a single guardian model capable of handling: Comprehensive safety risk classification Adversarial attack detection, including prompt injection and jailbreak attempts Various input modalities, such as standalone prompts, multi-turn conversations, and full agentic workflows Long-context inputs Multilingual inputs Explainable reasoning
...
HTML_TAG_END
### Community
[simonevanbruggen](/simonevanbruggen) [Jan 7](#695e752620e616cc0a80d534)
Interesting work! 👏 Will you also publish the translated multilingual benchmarks?
...
· [Sign up](/join?next=%2Fblog%2FServiceNow-AI%2Faprielguard) or [log in](/login?next=%2Fblog%2FServiceNow-AI%2Faprielguard) to comment
[Upvote 48](/login?next=%2Fblog%2FServiceNow-AI%2Faprielguard) +36 System theme Company [TOS](/terms-of-service) [Privacy](/privacy) [About](/huggingface) [Careers](https://apply.workable.com/huggingface/) Website [Models](/models) [Datasets](/datasets) [Spaces](/spaces) [Pricing](/pricing) [Docs](/docs) Stripe